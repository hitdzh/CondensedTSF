...
def main():
    ...
    parser = argparse.ArgumentParser(description='Autoformer & Transformer family for Time Series Forecasting (K-Center)')

    # basic config
    parser.add_argument('--is_training', type=int, default=1, help='status: 1=train, 0=test')
    parser.add_argument('--model_id', type=str, default='weather', help='model id')
    parser.add_argument('--model', type=str, default='Autoformer',
                        help='model name: [Autoformer, Informer, Transformer, Reformer]')
    ...
    parser.add_argument('--freq', type=str, default='10min',
                        help='freq for time features: [s, t, h, d, b, w, m, 10min, 15min]')
    parser.add_argument('--checkpoints', type=str, default='./outputs/checkpoints/', help='location of model checkpoints')

    # forecasting task
    parser.add_argument('--seq_len', type=int, default=336, help='input sequence length')
    parser.add_argument('--label_len', type=int, default=336, help='start token length (should equal seq_len for Autoformer)')
    parser.add_argument('--pred_len', type=int, default=96, help='prediction sequence length')

    # K-Center selection
    parser.add_argument('--use_kcenter', action='store_true', default=False,
                        help='whether to use K-Center for training data selection')
    parser.add_argument('--kcenter_k', type=int, default=500,
                        help='number of samples selected by K-Center')

    # model define
    parser.add_argument('--bucket_size', type=int, default=4, help='for Reformer')
    parser.add_argument('--n_hashes', type=int, default=4, help='for Reformer')
    parser.add_argument('--enc_in', type=int, default=21, help='encoder input size (num_features)')
    parser.add_argument('--dec_in', type=int, default=21, help='decoder input size (num_features)')
    parser.add_argument('--c_out', type=int, default=21, help='output size (num_features)')
    ...
    # time encoding
    parser.add_argument('--timeenc', type=int, default=0, help='0=manual, 1=time_features')
